...
void ASpiritController::SetupInputComponent()
{
	...
	InputComponent->BindAction("PauseButton", IE_Pressed, this, &ASpiritController::PauseAction);
	InputComponent->BindAction("AnyKey", IE_Pressed, this, &ASpiritController::AnyKeyAction);
	...
	InputComponent->BindAxis("GamepadForwardAxis", this, &ASpiritController::GamepadForwardAxis);
	InputComponent->BindAxis("GamepadRightAxis", this, &ASpiritController::GamepadRightAxis);
	...
	InputComponent->BindAxis("GamepadLookUpAxis", this, &ASpiritController::GamepadLookUpAxis);
	InputComponent->BindAxis("GamepadTurnAxis", this, &ASpiritController::GamepadTurnAxis);
}
